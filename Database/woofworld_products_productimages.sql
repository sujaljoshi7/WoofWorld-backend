...
CREATE TABLE `products_productimages` (
  ...
  PRIMARY KEY (`id`),
  KEY `products_productimag_Product_id_id_6b34b063_fk_products_` (`Product_id_id`),
  CONSTRAINT `products_productimag_Product_id_id_6b34b063_fk_products_` FOREIGN KEY (`Product_id_id`) REFERENCES `products_product` (`id`)
