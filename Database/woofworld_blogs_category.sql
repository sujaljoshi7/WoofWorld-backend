...
CREATE TABLE `blogs_category` (
  ...
  PRIMARY KEY (`id`),
  KEY `blogs_category_created_by_id_5942c18d_fk_auth_user_id` (`created_by_id`),
  CONSTRAINT `blogs_category_created_by_id_5942c18d_fk_auth_user_id` FOREIGN KEY (`created_by_id`) REFERENCES `auth_user` (`id`)
