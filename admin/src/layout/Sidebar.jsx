            ...
            <ul className="nav nav-pills flex-column mb-auto p-3">
              <li className="nav-item">
                <NavLink
                  to="/dashboard"
                  className={({ isActive }) =>
                    `nav-link ${isActive ? 'active bg-primary' : 'text-white'} d-flex align-items-center`
                  }
                >
                ...
                <li key={menu.name} className="nav-item">
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      {!isCollapsed && <span className="ms-3">{menu.name}</span>}
                    </div>
                    {!isCollapsed && (
                      <i
                        className={`fa-solid ${
                      ...
                      {menu.subItems.map((sub, index) => (
                        <li key={index}>
                          <NavLink
                            ...
                            className={({ isActive }) =>
                              `nav-link ${isActive ? 'active bg-primary' : 'text-white-50'}`
                            }
                            end
                          >
                            {sub}
          ...
          <div className="sidebar-footer p-3">
            <div className="dropdown">
              ...
              >
                ...
                />
                {!isCollapsed && <strong>{user ? user.first_name : "Loading..."}</strong>}
              </a>
