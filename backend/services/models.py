...
class Service(models.Model):
    ...
    image = models.ImageField(upload_to='services/', validators=[validate_image_size], default="")
    status = models.IntegerField()
    show_on_homepage = models.BooleanField(default=False)
    created_at = models.DateTimeField(default=datetime.now(), editable=False)
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='service_user', default="")