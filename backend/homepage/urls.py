...
from .views import hero, activate_hero, deactivate_hero, get_specific_hero_data, activate_partnercompany, deactivate_partnercompany, get_specific_company_data, PartnerCompanyView
